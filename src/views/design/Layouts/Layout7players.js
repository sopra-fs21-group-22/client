...
function Layout7players({visibility, hideCancel_PlayCard, setHideCancel_PlayCard}){
    ...
    return (<Container hidden={visibility}>
        ...
        <Row>
            <Col>
                {/*<OpponentDeck opponent={orderarray[5]} playeronturn={playertable.playerOnTurn} playertable={playertable} border={border} updateborder={setBorder} setCard_played={setCard_played} setHideCancel_PlayCard={setHideCancel_PlayCard}/>*/}
                <OpponentDeck opponent={null}/>
            </Col>
            <Col>
        ...
        <Row>
            <Col>
                {/*<OpponentDeck opponent={orderarray[6]} playeronturn={playertable.playerOnTurn} playertable={playertable} border={border} updateborder={setBorder} setCard_played={setCard_played} setHideCancel_PlayCard={setHideCancel_PlayCard}/>*/}
                <OpponentDeck opponent={null}/>
            </Col>
            <Col/>
            <Col>
